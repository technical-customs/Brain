...
public class Graph extends Screen{
    ...
    public void setPointLocation(Entity e, Point p){
        e.setLocation(p.x - (int)(e.getWidth()/2),p.y - (int)(e.getHeight()/2));
    }
    ...
    public static void main(String[] args){
        ...
        for(int xx = 0; xx < 3; xx++){
            ...
            graph.setPointLocation(p,np);
            //p.setLocation(np.x - (int)(p.getWidth()/2),np.y - (int)(p.getHeight()/2));
        }
        /*
        //Entity p = graph.addPoint(5,5);
        //graph.connectPoints(0,0, 5,5);
                ...
                //SwingUtilities.invokeLater(new Runnable(){
                    ...
                    //public void run(){
                        ...
                        for(int xx = 0; xx < kmeans.getClusters().length; xx++ ){
                            ...
                            graph.setPointLocation(e,kmeans.getClusters()[xx].getCentroid());
